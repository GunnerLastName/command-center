...
CREATE TABLE "new_Settings" (
    ...
    "keyboardShortcuts" TEXT NOT NULL DEFAULT '{}',
    "dayRolloverHour" INTEGER NOT NULL DEFAULT 2,
    "createdAt" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" DATETIME NOT NULL
);
INSERT INTO "new_Settings" ("createdAt", "dailyMinimumHours", "dailyStretchHours", "dashboardWidgets", "dayRolloverHour", "habitsScoreWeight", "id", "reviewScoreWeight", "tasksScoreWeight", "theme", "updatedAt", "userName", "workScoreWeight") SELECT "createdAt", "dailyMinimumHours", "dailyStretchHours", "dashboardWidgets", "dayRolloverHour", "habitsScoreWeight", "id", "reviewScoreWeight", "tasksScoreWeight", "theme", "updatedAt", "userName", "workScoreWeight" FROM "Settings";
DROP TABLE "Settings";
